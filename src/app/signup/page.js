        ...
        <div className="w-full max-w-sm">
          {done ? (
            <div className="bg-white border border-[#E8DDD8] rounded-2xl p-8 text-center shadow-sm">
              ...
              <p className="text-[#7A7068] text-sm">We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.</p>
            </div>
          ) : (
            <div className="bg-white border border-[#E8DDD8] rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-center text-xs text-[#7A7068] mt-5">
                ...
                <Link href="/login" className="text-[#C8102E] font-bold hover:underline">Log in</Link>
              </p>
            </div>
          )}
        </div>
